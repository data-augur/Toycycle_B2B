...
export const metadata: Metadata = {
  title: "Certified Partner Market",
  description:
    "A brand-approved secondary channel for professional B-stock. Sell excess and open-box inventory to families on a trusted platform that protects brand integrity.",
  openGraph: {
    title: "Certified Partner Market | Toycycle for Brands",
    description:
      "Brand-approved secondary channel for B-stock. Sell to families on a trusted platform.",
    url: `${siteUrl}/certified-partner-market`,
  },
  alternates: { canonical: `${siteUrl}/certified-partner-market` },
};
    ...
    <div className="tc-landing-wrapper">
        ...
        <div className="tc-content-container">
          <div className="tc-hero-grid">
            <div className="tc-hero-text-content">
              ...
              <p className="tc-title-secondary">
                A Brand-Approved Secondary Channel for Professional B-Stock
              </p>
              <p className="tc-hero-lead">
                Sell your excess and open-box inventory directly to families on
                a trusted platform that protects your brand integrity.
              </p>
              <Link href="/contact" className="tc-btn">
            ...
            <div className="tc-hero-image-container">
              <Image
                ...
                alt="Certified Partner Market – brand-approved secondary channel for B-stock"
      ...
      <section className="tc-info">
        <div className="tc-content-container">
          <div className="tc-glass-card tc-center">
            <h2 className="tc-heading-main">
              What Is the Certified Partner Market?
            </h2>
            <p className="tc-body-text-xl">
              The Toycycle Certified Partner Market is a brand-approved
              secondary commerce channel that allows businesses to list and sell
              their B-stock or surplus inventory directly to our engaged
              community — without disrupting core retail or DTC operations.
            </p>
            <div className="tc-divider"></div>
            <p
              className="tc-body-text-xl"
              style={{ fontWeight: 700, color: "var(--tc-brand-green)" }}
            >
              You keep inventory and fulfillment. <br />
              We bring demand, visibility, and trust.
            </p>
            <p
              className="tc-hero-lead"
              style={{ fontSize: "1.5rem", fontStyle: "italic" }}
            >
              It&apos;s not clearance. It&apos;s not liquidation. It&apos;s a
              controlled, certified marketplace built for smarter sell-through.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="tc-benefits">
        <div className="tc-content-container tc-center">
          <h2 className="tc-heading-main">
            Why Businesses Choose the Certified Partner Market
          </h2>
          <div className="tc-grid-list">
            <div className="tc-card tc-center">
              ...
              <p>
                Parents come to Toycycle for quality, sustainability, and value
                — not random bargains. That means faster velocity for verified
                B-stock.
              </p>
            </div>
            <div className="tc-card tc-center">
              ...
              <p>
                No off-price dumping. No unauthorized resellers. Your products
                live in a curated marketplace aligned with your brand values.
              </p>
            </div>
            <div className="tc-card tc-center">
              <div className="tc-svg-icon">
            ...
            <div className="tc-card tc-center">
              ...
              <p>
                You fulfill directly from your warehouse. We handle
                merchandising, promotion, and checkout without touching your
                supply chain.
              </p>
            </div>
          </div>
      ...
      <section className="tc-how tc-hero">
        <div className="tc-content-container tc-center">
          <h2 className="tc-heading-main">
            How It Works (Simple. Strategic. Seamless.)
          </h2>
          <div
            className="tc-grid-list"
            style={{
          ...
          >
            <div className="tc-step-item tc-center">
              ...
              <p className="tc-step-text">
                <strong>Select Inventory</strong>
                <br />
                B-stock, open-box, or surplus SKUs.
              </p>
            </div>
            <div className="tc-step-item tc-center">
            ...
            <div className="tc-step-item tc-center">
              ...
              <p className="tc-step-text">
                ...
                <br />
                Ship directly from your warehouse.
              </p>
            </div>
            <div className="tc-step-item tc-center">
              ...
              <p className="tc-step-text">
                ...
                <br />
                We manage visibility and trust.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="tc-why">
        <div className="tc-content-container">
          <div className="tc-grid-list">
            <div>
              <h2 className="tc-heading-main" style={{ textAlign: "left" }}>
                Why Toycycle?
              </h2>
              <p className="tc-body-text-xl">
                We&apos;re not another marketplace. We&apos;re a circular
                commerce partner built around:
              </p>
            ...
            <div
              ...
              style={{
                padding: "40px",
                background: "var(--tc-light-green)",
                border: "none",
              }}
            >
              <h3
                style={{
                  color: "var(--tc-brand-green)",
                  fontSize: "2rem",
                  marginBottom: "15px",
                }}
              >
      ...
      <section className="tc-cta tc-center">
        <div className="tc-content-container tc-center">
          <div
            className="tc-glass-card tc-center"
            style={{
              backgroundColor: "var(--tc-light-green)",
              border: "none",
              width: "100%",
            }}
          >
            <h2 className="tc-heading-main">
              Let&apos;s Make Surplus Inventory Matter
            </h2>
            <p className="tc-body-text-xl">
              Give your excess stock a second life — one that protects your
              brand, delivers stakeholder value, and reaches families who will
              truly use and love it.
            </p>
            <Link href="/contact" className="tc-btn">
