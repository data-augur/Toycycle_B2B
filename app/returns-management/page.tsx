...
export const metadata: Metadata = {
  title: "Returns Management for Toy Brands",
  description:
    "End-to-end returns management for toy brands. Expand your operations team, reduce loss from returns, and eliminate grey-market and safety risks.",
  openGraph: {
    title: "Returns Management for Toy Brands | Toycycle",
    description:
      "End-to-end returns management. Reduce loss, eliminate grey-market risk.",
    url: `${siteUrl}/returns-management`,
  },
  alternates: { canonical: `${siteUrl}/returns-management` },
};
...
export default function ReturnsManagement() {
  return (
    <div className="tc-landing-wrapper">
          ...
          <div className="tc-home-hero-grid">
            ...
            <div className="tc-home-hero-image">
              <Image
                ...
                alt="Toycycle Returns Management – hassle-free return solutions for toy brands"
                width={600}
                height={400}
      ...
      {/* Third Section */}
      <section
        style={{ padding: "60px 0", backgroundColor: "var(--tc-light-green)" }}
      >
        <div className="tc-content-container">
          <div
          ...
          >
            <h2 className="tc-section-title">
              Toycycle Returns Management — Hassle-Free Return Solutions for Toy
              Brands
            </h2>
            <p className="tc-home-section-text">
              Returns are a pain for businesses because they create logistical
              headaches, eat up profits, and require staffing to sort through.
            </p>
            <p className="tc-home-section-text">
              We turn your headaches into hassle-free solutions. From receiving
              to resale, we&apos;ve got you covered–so your team can stay
              focused on what drives growth.
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        className="tc-returns-process-section"
        style={{ backgroundColor: "#ffffff" }}
      >
        <div className="tc-content-container">
          <div
            className="tc-returns-process-container"
            ...
            <div className="tc-returns-process">
              <div className="tc-returns-step">
                <div className="tc-returns-step-number">
                  <Image
                    src="/images/returns_icons/box-check.svg"
                    alt="Receiving – step 1 of Toycycle returns process"
                    width={40}
                    height={40}
                  />
                  <h3>1 - Receiving</h3>
                ...
                <p>
                  We accept the returned item and log it into our system for
                  processing.
                </p>
              </div>
              <div className="tc-returns-step">
                <div className="tc-returns-step-number">
                  <Image
                    src="/images/returns_icons/square-check.svg"
                    alt="Quality and safety check – step 2 of Toycycle returns process"
                    width={40}
                    height={40}
                  />
                ...
                <p>
                  The item is carefully inspected to ensure it meets our safety
              ...
              <div className="tc-returns-step">
                <div className="tc-returns-step-number">
                  <Image
                    src="/images/returns_icons/sort-arrows.svg"
                    alt="Grading and sorting – step 3 of Toycycle returns process"
                    width={40}
                    height={40}
                  />
                ...
                <p>
                  Items are categorized based on condition and usability for
              ...
              <div className="tc-returns-step">
                <div className="tc-returns-step-number">
                  <Image
                    src="/images/returns_icons/camera.svg"
                    alt="Photography – step 4 of Toycycle returns process"
                    width={40}
                    height={40}
                  />
                  <h3>4 - Photography</h3>
                ...
                <p>
                  High-quality images are taken to showcase the product
                  accurately for resale.
                </p>
              </div>
              <div className="tc-returns-step">
                <div className="tc-returns-step-number">
                  <Image
                    src="/images/returns_icons/dollar.svg"
                    alt="Pricing – step 5 of Toycycle returns process"
                    width={40}
                    height={40}
                  />
                  <h3>5 - Pricing</h3>
                ...
                <p>
                  Each item is evaluated and priced fairly based on its
              ...
              <div className="tc-returns-step">
                <div className="tc-returns-step-number">
                  <Image
                    src="/images/returns_icons/exchange.svg"
                    alt="Repacking – step 6 of Toycycle returns process"
                    width={40}
                    height={40}
                  />
                  <h3>6 - Repacking</h3>
                ...
                <p>
                  Items are carefully repacked to ensure they meet quality and
                  presentation.
                </p>
              </div>
              <div className="tc-returns-step">
                <div className="tc-returns-step-number">
                  <Image
                    src="/images/returns_icons/storage.svg"
                    alt="Storage – step 7 of Toycycle returns process"
                    width={40}
                    height={40}
                  />
                  <h3>7 - Storage</h3>
                ...
                <p>
                  Processed items are safely stored in our warehouse ready for
                  resale.
                </p>
              </div>
              <div className="tc-returns-step">
                <div className="tc-returns-step-number">
                  <Image
                    src="/images/returns_icons/truck.svg"
                    alt="Resale fulfillment – step 8 of Toycycle returns process"
                    width={40}
                    height={40}
                  />
                ...
                <p>
                  Products are listed for sale and prepared for delivery to new
                  customers.
                </p>
              </div>
              <div className="tc-returns-step">
                <div className="tc-returns-step-number">
                  <Image
                    src="/images/returns_icons/help.svg"
                    alt="Customer care – step 9 of Toycycle returns process"
                    width={40}
                    height={40}
                  />
                ...
                <p>
                  Our team is available to assist with any queries or support
      ...
      <section
        className="tc-home-section-difference"
        style={{ backgroundColor: "var(--tc-light-green)" }}
      >
        <div className="tc-content-container">
          <div className="tc-difference-content">
            ...
            <div
              className="tc-difference-pillars-grid"
              style={{
            ...
            >
              <div className="tc-difference-pillar-card">
                ...
                <p className="tc-difference-pillar-text">
                  Unlike other platforms, we do not charge for handling your
                  returns. We only charge a percentage of the sale once we
                  resell the item through our platform
                </p>
              </div>
              <div className="tc-difference-pillar-card">
                <div className="tc-difference-pillar-icon">📈</div>
                <h3 className="tc-difference-pillar-title">
                  Maximum Value Recovery Through Resale
                </h3>
                <p className="tc-difference-pillar-text">
                  Instead of discarding unsellable items, we refurbish and
                  resell them.
                </p>
              </div>
              <div className="tc-difference-pillar-card">
                ...
                <p className="tc-difference-pillar-text">
                  We reduce waste by extending the life of products.
                </p>
              </div>
              <div className="tc-difference-pillar-card">
                <div className="tc-difference-pillar-icon">🔌</div>
                ...
                <p className="tc-difference-pillar-text">
                  Real-time receipt integration for returns (API, EDI, SAP,
                  Slack, etc.).
                </p>
              </div>
              <div className="tc-difference-pillar-card">
                ...
                <p className="tc-difference-pillar-text">
                  Real-time notifications of fraudulent returns.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="tc-content-container">
          <h2 className="tc-section-title">
            Choose the Right Plan for Your Circular Goals
          </h2>
          <p
          ...
          >
            Whether you&apos;re just starting out or scaling a zero-waste
            strategy, our flexible plans make returns management simple,
            ...
            <div className="tc-pricing-card tc-pricing-card-ribbon">
              ...
              <div className="tc-pricing-card-inner">
                ...
                <div className="tc-pricing-cta">
                  <Link href="/contact" className="tc-btn tc-btn-outline">
                    Contact Us
                  </Link>
                </div>
              </div>
      ...
      <section className="tc-home-cta">
        <div className="tc-content-container tc-center">
          ...
          <p className="tc-cta-text">
            Let Toycycle handle your returns so you can focus on growing your
            business.
          </p>
          <Link href="/contact" className="tc-btn tc-btn-primary">
            Contact Us
